<template>
  ...
  <div class="register-container">
    <div class="register-form">
      <el-header class="register-header" height="45px">
        <img src="@/assets/logo.jpeg" style="width: 45px; margin-right: 10px;">
        <span class="register-title" style="margin-right: 10px;">注册</span>
      ...
      <div class="form">
        <el-form :model="form" status-icon :rules="rules" ref="form">
          ...
          <el-input type="password" show-password v-model="form.confirmPwd" autocomplete="off" placeholder="请再次输入密码"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button type="success" class="submit" v-preventReClick @click="register('form')">确认注册</el-button>
            
            <span class="pull-right" style="margin-left: 140px;">
              已有账号。
              <el-button type="primary" @click="toLogin">点此登录</el-button>
            </span>
          </el-form-item>
        </el-form>
      </div>
