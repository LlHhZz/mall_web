          ...
          <el-card :body-style="{ padding: '0px' }">
            <div class="cart-item">
              ...
              <div class="product-item-size">
                <span class="product-quantity-title">规格/款式：</span>
              ...
              <div class="product-item-price">
                ...
                <span class="product-price" style="color: #ff8028;">￥{{ product.amount }}</span>
              </div>
...
const initData = () => {
  ...
  axios.post("http://127.0.0.1:3000/cart/getlist/byUsername/", {
